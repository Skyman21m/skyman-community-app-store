...
Test community app store hosting a fork of Alby Hub that lets the user pick the
Nostr relay used for NWC connections from the Settings UI.
...
Install **Alby Hub (Relay Select)** from the store.
